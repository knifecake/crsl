...
class CarouselsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create carousel" do
    assert_difference('Carousel.count') do
      post carousels_url, params: { carousel: { title: @carousel.title, user_id: @carousel.user_id } }
    end
  ...
  test "should update carousel" do
    patch carousel_url(@carousel), params: { carousel: { title: @carousel.title, user_id: @carousel.user_id } }
